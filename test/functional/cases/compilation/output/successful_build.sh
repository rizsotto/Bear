...
# RUN: assert_compilation %t.json contains -file successful_build_2.c -directory %T -arguments %{c_compiler} -c -o successful_build_2.o successful_build_2.c
# RUN: assert_compilation %t.json contains -file successful_build_3.c -directory %T -arguments %{cxx_compiler} -c -o successful_build_3.o successful_build_3.c
# RUN: assert_compilation %t.json contains -file successful_build_4.c -directory %T -arguments %{cxx_compiler} -c -o successful_build_4.o successful_build_4.c
