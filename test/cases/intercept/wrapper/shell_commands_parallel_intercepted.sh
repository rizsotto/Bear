...
# RUN: assert_intercepted %t.json contains -arguments cc -c shell_commands_parallel_intercepted.c -o shell_commands_parallel_intercepted.2.o
# RUN: assert_intercepted %t.json contains -arguments cc -c shell_commands_parallel_intercepted.c -o shell_commands_parallel_intercepted.3.o
