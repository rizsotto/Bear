...
# RUN: assert_compilation %t.json contains -file flags_filtered_preproc_2.c -directory %T -arguments %{c_compiler} -c -o flags_filtered_preproc_2.o flags_filtered_preproc_2.c
