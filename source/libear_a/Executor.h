...
namespace ear {
    ...
    public:
        ...
        int execve(const char *path, char *const argv[], char *const envp[]) const noexcept {
            ...
            const char **it = dst;
            *it++ = parameters.reporter.reporter;
            *it++ = destination_flag;
            *it++ = parameters.reporter.destination;
            *it++ = library_flag;
            ...
            *it++ = "--";
            ...
            return fp(parameters.reporter.reporter, const_cast<char *const *>(dst), envp);
        }
#endif
        ...
        int execv(const char *path, char *const argv[]) const noexcept {
            ...
            *it++ = "--";
            ...
            return fp(parameters.reporter.reporter, const_cast<char *const *>(dst));
        }
#endif
        ...
        int execvpe(const char *file, char *const argv[], char *const envp[]) const noexcept {
            ...
            *it++ = "--";
            ...
            auto fp = Resolver::execve();
            return (fp == nullptr) ? -1 : fp(parameters.reporter.reporter, const_cast<char *const *>(dst), envp);
        }
#endif
        ...
        int execvp(const char *file, char *const argv[]) const noexcept {
            ...
            *it++ = "--";
            ...
            auto fp = Resolver::execv();
            return (fp == nullptr) ? -1 : fp(parameters.reporter.reporter, const_cast<char *const *>(dst));
        }
#endif
        ...
        int posix_spawn(pid_t *pid, const char *path,
            ...
            *it++ = "--";
            ...
            return fp(pid, parameters.reporter.reporter, file_actions, attrp, const_cast<char *const *>(dst), envp);
        }
#endif
        ...
        int posix_spawnp(pid_t *pid, const char *file,
            ...
            *it++ = "--";
            ...
            auto fp = Resolver::posix_spawn();
            return (fp == nullptr) ? -1 : fp(pid, parameters.reporter.reporter, file_actions, attrp,
